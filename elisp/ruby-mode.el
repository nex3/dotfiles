...
(defconst ruby-font-lock-keywords
  (list
   ...
   ;; interpolation
   '(ruby-highlight-interpolation 1 font-lock-variable-name-face prepend)
   ;; variables
...
(defun ruby-fontify-region (beg end)
  "Use fontify the region between BEG and END as Ruby.
...
(defun ruby-limited-forward-sexp (limit &optional arg)
...
(defun ruby-highlight-interpolation (limit)
